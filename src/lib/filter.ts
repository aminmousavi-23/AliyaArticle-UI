import { type FilterDto, type FilterItemDto } from '@/types/api'
...
export function buildFilter(
  items: Array<{ field: string; operation?: FilterOperation_Enum; value: unknown }>,
  ...
  const cleaned: FilterItemDto[] = items
    ...
    .map((i) => ({ field: i.field, operation: i.operation ??
          FilterOperation_Enum.Equal, value: i.value }))
